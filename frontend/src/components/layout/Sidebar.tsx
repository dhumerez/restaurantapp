...
const navItems: NavItem[] = [
  ...
  { label: "Config. Mesas",  path: "/admin/tables", icon: HiOutlineTable,        roles: ["admin"] },
...
export function Sidebar() {
  ...
  return (
    <aside className="w-56 bg-surface-1 border-r border-surface-border min-h-screen flex flex-col shrink-0">
      {/* Brand */}

    ...
    <div className="min-h-screen bg-surface-0 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-primary-500/10 border border-primary-500/20 mb-5 shadow-glow-amber">
          ...
          <h1 className="font-display text-4xl font-semibold text-ink-primary tracking-wide mb-2">
            Restaurante
          </h1>
        ...
        {/* Card */}
        <div className="bg-surface-1 border border-surface-border rounded-2xl p-8 shadow-modal">
          <h2 className="font-display text-xl font-semibold text-ink-primary mb-6 tracking-wide">
            Iniciar sesión
          </h2>
        ...
        {/* Demo credentials */}
        <div className="mt-5 p-4 bg-surface-1/50 border border-surface-border rounded-xl">
          ...
          <div className="space-y-1">
            {[
              ...
              <button
                ...
                className="w-full flex items-center justify-between px-3 py-1.5 rounded-lg hover:bg-surface-2 transition-colors group"
              >
